...
if (currentUser) {
	if (currentUser.role === "ROLE_ADMIN") {
		navInfo.innerHTML = `<li><a class="dropdown-item text-white" href="/pages/admin-becas.html">Becas</a></li>
        <li><a class="dropdown-item text-white" href="/pages/admin-users.html">Usuarios</a></li>
